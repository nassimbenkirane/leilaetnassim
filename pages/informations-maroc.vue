  ...
  <section class="section has-text-centered">
    <div class="container is-size-5">
      ...
      <p>
        ...
        Sur <a target="_blank" href="https://www.officetourismemaroc.com/region/tourisme-maroc-region-Casablanca-Settat.html">l'Office de tourisme Marocain</a><br>
      </p>
      <section class="section">
        ...
        <p>
          ...
          A l'exception des quartiers très touristiques, et particulièrement à Casablanca,<br>
        ...
        <p>
          ...
          Ils ont des compteurs et il ne faut pas hesiter à demander à bien mettre le compteur.<br>
      ...
      <section class="section">
        ...
        <ul>
          ...
          <li>Le Quartier des Habous et l'ancienne Mahakma du Pacha</li>
          <li>La corniche, pour voir la mer</li>
        ...
        <ul>
          ...
          <li>Le Mausolée de Mohammed V et la Tour Hassan</li>
          <li>La Kasbah des Oudaias</li>
          <li>La Médina et la rue des consuls</li>
        ...
        <ul>
          ...
          <li>Le quartier des andalous</li>
          <li>Le quartier des tanneurs</li>
          <li>La mosquée Karaouyine</li>
          <li>Quartier d'El Jedid</li>
        ...
        <ul>
          ...
          <li>La Medersa Bou Inania, El Jedid</li>
          <li>Les ruines romaines de Volubilis</li>
        </ul>
      </section>
    </div>
  </section>
